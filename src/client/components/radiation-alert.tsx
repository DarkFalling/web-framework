...
import "./radiation-alert.scss"

export default function RadiationAlert(props: any) {
    return (
        <div className="radiation-alert">
            <div className="block block--animation">
                <svg width="100%" height="100%" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="radiation-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
